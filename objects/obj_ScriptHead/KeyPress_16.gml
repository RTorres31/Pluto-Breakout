...
/// @DnDVersion : 1
/// @DnDHash : 1D57CD91
/// @DnDArgument : "code" "show_message("NOTE: Space bar releases the ball, but also can be used to speed the ball up if it is going to slow for your taste. Do at own risk, because only non-point collisions (walls, ceiling, bounce-bar) can slow it down! If you are confused on how to play, press the Shift Key to see these 'How-To-Play' Pop-Ups any number of times! Good Luck!")"
...
/// @DnDVersion : 1
/// @DnDHash : 6B99CEF2
/// @DnDArgument : "code" "show_message("Feel free to left-click on any of the 4 Different Colored Example Bricks [with your left mouse-button] on the right of the 'Play Screen' at any time to learn more about the difficulties you're up against!")"
show_message("Feel free to left-click on any of the 4 Different Colored Example Bricks [with your left mouse-button] on the right of the 'Play Screen' at any time to learn more about the difficulties you're up against!")